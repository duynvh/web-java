...
<!--            <div class="row">
            ...
            <div class="box">
                <div style="padding: 20px;">
                    <a href="${root}/admin/insert-product.jsp" class="btn btn-info">Thêm sản phẩm</a>
                </div>
                            ...
                            <div class="col-sm-12">
                                <table id="example1" class="table table-bordered table-striped dataTable" role="grid"
                                    ...
                                    <tr class="gradeX odd" role="row">
                                        ...
                                        <td><%=productDAO.getNameCategoryWhereCategoryID(product.getCategory_id())%></td>
                                        <td><img src="${pageContext.request.contextPath}/upload/<%=product.getImage()%>" width="150px" height="100px" alt="No Image"/></td>
                                        <td><%=product.getName()%></td>
                                        <td><%=product.getPrice()%></td>
                                        <td>
                                            <a title="Edit" class="btn btn-info btn-action-edit"
                                               href="${root}/admin/update-product.jsp?product_id=<%=product.getId()%>">
                                                <i class="fa fa-pencil fa-fw"></i>
                                            </a>
                                            <a title="Delete" class="btn btn-danger btn-action-delete"
                                               href="/mobile-shop/DeleteProductServlet?id=<%=product.getId()%>">
