...
<!--            <div class="row">
            ...
            <div class="box">
                <div style="padding: 20px;">
                    <a href="${root}/admin/insert-user.jsp" class="btn btn-info">Thêm người dùng</a>
                </div>
                                    ...
                                    <tr class="gradeX odd" role="row">
                                        ...
                                        <td>
                                            <a title="Edit" class="btn btn-info btn-action-edit"
                                               href="${root}/admin/update-user.jsp?user_id=<%=user.getId()%>">
                                                <i class="fa fa-pencil fa-fw"></i>
                                            </a>
                                            <a title="Delete" class="btn btn-danger btn-action-delete"
                                               href="/mobile-shop/DeleteUserServlet?id=<%=user.getId()%>">
